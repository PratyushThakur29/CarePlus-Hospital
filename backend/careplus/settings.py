"""
Django settings for CarePlus Hospital backend.
"""
...
# Database
# Uses DATABASE_URL (Supabase PostgreSQL connection string) when provided,
# otherwise falls back to local sqlite for quick local development.
